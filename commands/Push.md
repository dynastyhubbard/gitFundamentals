...
When you have a [remote] (./REMOTE.md) set up you'll need to bein to move [commits](./COMMIT.md) to the remote. This can be done with the command `git push`.
...
- [Git Push Documentation](https://git-scm.com/docs/git-commit)
